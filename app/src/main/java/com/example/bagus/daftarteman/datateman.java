...
package com.example.bagus.daftarteman;
...
public class datateman extends AppCompatActivity {
    ...
    private void showdata() {
        ...
        switch (nama) {
            ...
            case "Muhamad Ramdani":
                nim.setText("NIM: 10116009");
                getnama.setText("Nama: Muhamad Ramdani");
                kelas.setText("Kelas: IF-1");
                telepon.setText("Telepon : 08543252627");
                email.setText("Email : mramdani@gmail.com");
                sosmed.setText("Sosmed : muhamadramdani");
                break;
